<?php 
    ...
    if(isset($_GET['idHapus'])){
        $makanan->hapusMakanan($_GET['idHapus']);
    }
?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <a href="formTambahMakanan.php" class="btn btn-primary">Tambah Makanan</a>
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">Id Makanan</th>
                                            <th class="border-top-0">Gambar Makanan</th>
                                            <th class="border-top-0">Nama Makanan</th>
                                            <th class="border-top-0">Harga Makanan</th>
                                            <th class="border-top-0">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach($makanan->getMakanan() as $i => $mkn): ?>
                                            <tr>
                                                <td><?= $mkn['id_makanan'] ?></td>
                                                <td><img width="150px" src="../images/<?= $mkn['gambar_makanan'] ?>" alt=""></td>
                                                <td><?= $mkn['nama_makanan'] ?></td>
                                                <td><?= $mkn['harga_makanan'] ?></td>
                                                <td>
                                                    <a href="formUbahMakanan.php?idUbah=<?= $mkn['id_makanan'] ?>">Ubah</a>
                                                    <a href="?idHapus=<?= $mkn['id_makanan'] ?>">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
