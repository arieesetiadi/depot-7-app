<?php 
    ...
    if(isset($_GET['idHapus'])){
        $minuman->hapusMinuman($_GET['idHapus']);
    }
?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <a href="formTambahMinuman.php" class="btn btn-primary">Tambah Minuman</a>
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">Id Minuman</th>
                                            <th class="border-top-0">Gambar Minuman</th>
                                            <th class="border-top-0">Nama Minuman</th>
                                            <th class="border-top-0">Harga Minuman</th>
                                            <th class="border-top-0">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach($minuman->getMinuman() as $i => $mnm): ?>
                                            <tr>
                                                <td><?= $mnm['id_minuman'] ?></td>
                                                <td><img width="150px" src="../images/<?= $mnm['gambar_minum'] ?>" alt=""></td>
                                                <td><?= $mnm['nama_minuman'] ?></td>
                                                <td><?= $mnm['harga_minuman'] ?></td>

                                                <td>
                                                    <a href="formUbahMinuman.php?idUbah=<?= $mnm['id_minuman'] ?>">Ubah</a>
                                                    <a href="?idHapus=<?= $mnm['id_minuman'] ?>">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
